...
public class ListViewAdapter extends BaseAdapter {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            ...
            viewHolder.textViewRssi = view.findViewById(R.id.text_view_rssi);
        ...
        viewHolder.textViewRssi.setText(epcBeanArrayList.get(i).getRssi() + "");
        return view;
    }

    class ViewHolder {
        public TextView textViewIndex, textViewType, textViewEpc, textViewCount, textViewRssi;
    }
}
